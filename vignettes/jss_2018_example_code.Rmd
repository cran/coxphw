---
title: "R code for 'Weighted Cox Regression using the R package coxphw'"
author: "Daniela Dunkler"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette 
vignette: >
  %\VignetteIndexEntry{R code for 'Weighted Cox Regression using the R package coxphw'}
...
This is the R example code from 'Weighted Cox Regression Using the R Package **coxphw**' by [Dunkler, Ploner, Schemper and Heinze (Journal of Statistical Software, 2018, 84: 1-26, doi: 10.18637/jss.v084.i02](https://www.jstatsoft.org/article/view/v084i02)). It works with R >=3.2.2 and **coxphw** package >=4.0.0.
